	...
	renderResultsHTML (posts) {
		if (posts.length) {
			this.resultsArea.innerHTML = DOMPurify.sanitize(`<div class="list-group shadow-sm">
                    ...
                    <span class="text-muted small">by ${post.author.username} on ${postDate.getMonth() +
			...
			this.resultsArea.innerHTML = `<p class='alert alert-danger text-center shadow-sm'>Sorry, no results could be found for that search</p>`;
		}
		this.hideLoaderIcon();
